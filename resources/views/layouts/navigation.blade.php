        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboards.index')" :active="request()->routeIs('dashboards.index')">
                        {{ __('Home') }}
                    </x-nav-link>
                </div>
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('laporans.index')" :active="request()->routeIs('laporans.index')">
                        {{ __('Laporan') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('kinerja.index')" :active="request()->routeIs('kinerja.index')">
                        {{ __('Kinerja') }}
                    </x-nav-link>
                </div>
                @endif
                @if (Auth::user()->level=='admin')
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('catatans.index')" :active="request()->routeIs('catatans.index')">
