    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('laporans.update', $laporan->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <section class="bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg">
                    <div class="py-10 px-6 mx-auto max-w-screen-lg text-center">
                        ...
                        <h1 class="mb-6 text-4xl font-extrabold text-gray-800 dark:text-white">
                            <span class="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-emerald-500">
                                Triwulan I
                            </span>
                        </h1>
                        <div class="grid gap-6 md:grid-cols-3">
                            <div>
                                ...
                                <input
                                    ...
                                    type="text" name="target_t1" value="{{ old('target_t1', $laporan->target_t1) }}"
