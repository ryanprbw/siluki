                        ...
                        <div class="grid gap-6  md:grid-cols-3 m-4 ">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="realisasi_ctt_t1"
                                    value=" {{ old('realisasi_ctt_t1', $laporan->realisasi_ctt_t1) }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_pendorong_t1"
                                    value="{{ old('faktor_pendorong_t1', $laporan->faktor_pendorong_t1) }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_penghambat_t1"
                                    value="{{ old('faktor_penghambat_t1', $laporan->faktor_penghambat_t1) }}"
                                    placeholder="Masukkan %">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3 m-4 ">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="realisasi_ctt_t2"
                                    value="{{ old('realisasi_ctt_t2', $laporan->realisasi_ctt_t2) }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_pendorong_t2"
                                    value="{{ old('faktor_pendorong_t2', $laporan->faktor_pendorong_t2) }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_penghambat_t2"
                                    value="{{ old('faktor_penghambat_t2', $laporan->faktor_penghambat_t2) }}"
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3 m-4 ">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="realisasi_ctt_t3"
                                    value="{{ old('realisasi_ctt_t3', $laporan->realisasi_ctt_t3) }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_pendorong_t3"
                                    value="{{ old('faktor_pendorong_t3', $laporan->faktor_pendorong_t3) }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_penghambat_t3"
                                    value="{{ old('faktor_penghambat_t3', $laporan->faktor_penghambat_t3) }}"
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3 m-4 ">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="realisasi_ctt_t4"
                                    value="{{ old('realisasi_ctt_t4', $laporan->realisasi_ctt_t4) }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_pendorong_t4"
                                    value="{{ old('faktor_pendorong_t4', $laporan->faktor_pendorong_t4) }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_penghambat_t4"
                                    value="{{ old('faktor_penghambat_t4', $laporan->faktor_penghambat_t4) }}"
