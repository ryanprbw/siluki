            ...
            <form action="{{ route('laporans.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    <label for="sasaran"
                        ...
                        type="text" class="form-control @error('sasaran') is-invalid @enderror"
                        name="sasaran" value="{{ old('sasaran') }}" placeholder="Masukan Sasaran">
                </div>
                <div class="mb-6">
                    <label for="indikator"
                        ...
                        <input
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        type="text" class="form-control @error('indikator') is-invalid @enderror"
                        name="indikator" value="{{ old('indikator') }}" placeholder="Masukan Indikator">
                </div>
                <div class="mb-6">
                    <label for="target"
                        ...
                        <input
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        type="text" class="form-control @error('target') is-invalid @enderror"
                        name="target" value="{{ old('target') }}" placeholder="Masukan Target">
                </div>
                <div class="mb-6">
                    <label for="satuan"
                        ...
                        name="satuan" value="{{ old('satuan') }}" placeholder="Masukan Satuan">
                </div>
                        ...
                        <div class="grid gap-6  md:grid-cols-3 m-4 ">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="target_t1" value="{{ old('target_t1') }}" placeholder="Masukkan Target Triwulan I">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="realisasi_t1" value="{{ old('realisasi_t1') }}" placeholder="Masukkan Realisasi Triwulan I">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3 m-4 ">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="target_t2" value="{{ old('target_t2') }}" placeholder="Masukkan Target Triwulan 2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="realisasi_t2" value="{{ old('realisasi_t2') }}" placeholder="Masukkan Target Triwulan II">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3 m-4 ">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="target_t3" value="{{ old('target_t3') }}" placeholder="Masukkan Target Triwulan III">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="realisasi_t3" value="{{ old('realisasi_t3') }}" placeholder="Masukkan Realisasi Triwulan III">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3 m-4 ">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="target_t4" value="{{ old('target_t4') }}" placeholder="Masukkan Sasaran Triwulan IV">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="realisasi_t4" value="{{ old('realisasi_t4') }}" placeholder="Masukkan Realisasi Triwulan IV">
                        ...
                        <div class="grid gap-6  md:grid-cols-3 m-4 ">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="realisasi_ctt_t1" value="{{ old('realisasi_ctt_t1') }}" placeholder="Masukkan Catatan Realisasi Triwulan I">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_pendorong_t1" value="{{ old('faktor_pendorong_t1') }}" placeholder="Masukkan Faktor Pendorong Triwulan I">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3 m-4 ">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="realisasi_ctt_t2" value="{{ old('realisasi_ctt_t2') }}" placeholder="Masukkan Catatan Realisasi Triwulan II">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_pendorong_t2" value="{{ old('faktor_pendorong_t2') }}" placeholder="Faktor Pendorong Triwulan II">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_penghambat_t2" value="{{ old('faktor_penghambat_t2') }}" placeholder="Faktor Penghambat Triwulan II">
                            </div>
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3 m-4 ">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="realisasi_ctt_t3" value="{{ old('realisasi_ctt_t3') }}" placeholder="Masukkan Catatan Realisasi Triwulan III">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_pendorong_t3" value="{{ old('faktor_pendorong_t3') }}" placeholder="Masukkan Faktor Pendorong Triwulan III">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_penghambat_t3" value="{{ old('faktor_penghambat_t3') }}" placeholder="Masukkan Faktor Penghambat Triwulan III">
                            </div>
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3 m-4 ">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="realisasi_ctt_t4" value="{{ old('realisasi_ctt_t4') }}" placeholder="Masukkan Catatan Realisasi Triwulan IV">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_pendorong_t4" value="{{ old('faktor_pendorong_t4') }}" placeholder="Masukkan Faktor Pendorong Triwulan IV">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="faktor_penghambat_t4" value="{{ old('faktor_penghambat_t4') }}" placeholder="Masukkan Faktor Penghambat Triwulan IV">
                            </div>
                        </div>
                    </div>
                </section>
